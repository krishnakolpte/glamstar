			...
			<div className="max-w-7xl mx-auto px-6">
				...
				<div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-6">
					...
					<p className="text-white/40 max-w-xs text-[10px] uppercase tracking-[0.3em] md:text-right leading-relaxed font-bold">
						Honoring the exceptional talent of Season 2 finalists
						who redefined the runway.
					</p>
				</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-10">
					{WINNERS.map((winner) => (
						<motion.div
							...
							transition={{ duration: 0.8, delay: winner.delay }}
							viewport={{ once: true }}
						...
						>
							...
							<div className="relative h-[450px] overflow-hidden">
								...
								{/* Glass Badge */}
								<div className="absolute top-6 left-6 w-12 h-12 bg-primary/20 backdrop-blur-md border border-primary/30 rounded-full flex items-center justify-center text-primary shadow-2xl">
									<winner.icon size={20} />
								</div>
